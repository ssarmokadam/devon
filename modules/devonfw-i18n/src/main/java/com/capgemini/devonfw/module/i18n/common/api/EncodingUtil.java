...
public interface EncodingUtil {
  ...
  /**
   * The encoding {@code US-ASCII} (American Standard Code for Information Interchange) also just called {@code ASCII}. <br>
   ...
   * provided by {@code inputStream} is NOT in such encoding, it will use the given {@code nonUtfEncoding} as fallback. <br>
