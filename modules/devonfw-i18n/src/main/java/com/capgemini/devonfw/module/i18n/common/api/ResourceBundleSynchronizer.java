...
// usage = NlsBundleI18nEnRoot.MSG_SYNCHRONIZER_USAGE_MODE_DEFAULT)
usage = "Create and/or " + "update resource-bundle property-files from <bundle-class> for the given "
...
public class ResourceBundleSynchronizer extends AbstractVersionedMain {
  ...
  // usage = NlsBundleI18nEnRoot.MSG_SYNCHRONIZER_USAGE_ENCODING)
  ...
  // required = true, usage = NlsBundleI18nEnRoot.MSG_SYNCHRONIZER_USAGE_LOCALES)
  required = true, usage = "The list of locales "
   ...
   * 
   * ResourceBundleSynchronizer synchronizer = new ResourceBundleSynchronizer(); synchronizer.runAndExit(arguments); }
   */
